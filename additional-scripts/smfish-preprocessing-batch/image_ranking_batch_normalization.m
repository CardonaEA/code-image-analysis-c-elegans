function [img_mean, img_median, img_mode] = image_ranking_batch_normalization(image_Data, blocks_processing, parameters)
% preprocessing
...
[blocks_processing, SDc, img_mean, img_median, img_mode] = image_ranking_normalization(Raw_Image, image_Data, parameters.ranking_mask_size, blocks_processing, options);
