function [var_Names, TS, Cond_IDs, CC, Ncells, Tout, oo_area] = granules_info_epi_batch(Folder_Data, seg_parameters, r, img_stack)
%=== structures
...
granule_idx = zeros(ccS.NumObjects,1);
...
%==== results
TS{(c+1)/2} = [cell_idx, granule_idx, DgS.SurfaceArea, DgS.Volume,...
    (power(36*pi*power(DgS.Volume,2),1/3)) ./ (DgS.SurfaceArea),...
    rawInt, cumInt, medianInt,...
