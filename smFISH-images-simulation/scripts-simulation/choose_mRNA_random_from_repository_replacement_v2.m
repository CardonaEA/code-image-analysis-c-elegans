function [pos_mRNAs, repository_filtered, repository_fit_values_filtered] = choose_mRNA_random_from_repository_replacement_v2(repository, repository_fit_values, number_mRNAs_to_place, replicates_simulation, replacement_flag)
...
repository_fit_values_filtered = repository_fit_values(~empty_cells,:);
