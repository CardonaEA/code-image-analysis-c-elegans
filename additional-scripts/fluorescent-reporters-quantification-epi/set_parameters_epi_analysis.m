function [parameters, blocks_processing, image_file] = set_parameters_epi_analysis(filter_size, granule_threshold, small_objects_size, pixel_size_in_x_and_y, pixel_size_in_z, ranking_mask_size, components_conn, slides_out_of_focus, half_gonad, image_files, outline_files)
%==== analysis parameters
parameters        = struct;
...
% file IDs
image_file.GFP                 = image_files;
image_file.ROIs                = outline_files;
end