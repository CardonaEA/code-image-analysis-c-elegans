%====== Outlines for FQ
% includes feedback
function [FQ_sites, CC, Cond_IDs] = Create_Outlines_FQ_v2(Folder_Data, number_cells, Outlines_cells, Mask_image, CC, Cond_IDs, seg_parameters, analysis_parameters, microcope_par)
